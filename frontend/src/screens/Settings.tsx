  ...
  return (
    <Background>
      <div style={{
        ...
        <div style={{ fontSize: 17, fontWeight: 700, flex: 1 }}>Goals & Settings</div>
        <motion.button
          whileTap={{ scale: 0.94 }}
          onClick={handleSave}
          style={{
      ...
      <div style={{ paddingTop: 64, paddingBottom: 40, height: '100%', overflowY: 'auto' }}>
        ...
        {/* Goal */}
        <div style={{ padding: '12px 16px 6px' }}>
          <div style={{ fontSize: 10, color: theme.textMute, fontFamily: theme.mono, letterSpacing: 1.5, marginBottom: 6 }}>FITNESS GOAL</div>
        ...
        <div style={{ padding: '0 16px 6px' }}>
          <div style={{ fontSize: 10, color: theme.textMute, fontFamily: theme.mono, letterSpacing: 1.5, marginBottom: 6 }}>DIET TYPE</div>
          <Card style={{ borderRadius: 18, padding: '14px 16px' }}>
            <PillSelect<Diet>
              options={[
        ...
        {/* Activity */}
        <div style={{ padding: '0 16px 6px' }}>
          <div style={{ fontSize: 10, color: theme.textMute, fontFamily: theme.mono, letterSpacing: 1.5, marginBottom: 6 }}>ACTIVITY LEVEL</div>
          <Card style={{ borderRadius: 18, overflow: 'hidden', padding: 0 }}>
            {([
              ...
              >
                <div style={{
                  ...
                  border: `2px solid ${activity === opt.id ? theme.accent : 'rgba(255,255,255,0.2)'}`,
                ...
                <div>
                  <div style={{ fontSize: 13, fontWeight: activity === opt.id ? 700 : 400 }}>{opt.label}</div>
                  <div style={{ fontSize: 11, color: theme.textMute }}>{opt.sub}</div>
                </div>
              </motion.div>
            ))}
          </Card>
        ...
        <div style={{ padding: '0 16px 12px' }}>
          <div style={{ fontSize: 10, color: theme.textMute, fontFamily: theme.mono, letterSpacing: 1.5, marginBottom: 8, marginTop: 4 }}>
            AI BACKEND URL
          </div>
          <Card style={{ borderRadius: 14, padding: '4px 0' }}>
            <div style={{ padding: '10px 14px' }}>
              <div style={{ fontSize: 10, color: theme.textMute, fontFamily: theme.mono, marginBottom: 6 }}>API URL</div>
              <input
                value={apiInput}
          ...
          <div style={{ fontSize: 10, color: theme.textMute, marginTop: 6, lineHeight: 1.5 }}>
